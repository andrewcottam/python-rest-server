...
databases = {
    "<dbname>": dict(connectionString="dbname='<dbname>' host='<name.domain.org>' user='<dbuser>' password='<password>'", description="<Description that will appear in the services directory>")
}
